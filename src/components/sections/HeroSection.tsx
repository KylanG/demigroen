...
async function getHeroMedia() {
  return await client.fetch(`*[_type == "heroSettings"][0]{ video, image }`)
}

export default async function HeroSection({ heading, text, primaryButton, secondaryButton }: any) {
  ...
  return (
    <section className="relative w-full h-[90vh] overflow-hidden">
      ...
      {/* Achtergrond video of afbeelding uit Hero Instellingen */}
      {video ? (
